...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(Macro_1), TYPEID_MACRO, WORD(9),
		CMD_CHANGE_CHILD_POSITION, ID(DataMask_Home), ID(Container_Gesamtzaehler), WORD(100), WORD(30),
	ID(Macro_2), TYPEID_MACRO, WORD(9),
		CMD_CHANGE_CHILD_POSITION, ID(DataMask_Home), ID(Container_Gesamtzaehler), WORD(5), WORD(5),
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 9, 0, 
		...
		XYREF(Button_1, 400, 1),
		XYREF(Button_2, 400, 100),
	...
	ID(Button_1), TYPEID_BUTTON, WORD(80), WORD(80), 1, 160, 1, 0, 1, 1, 
		XYREF(OutputString_S1, 0, 0),
		MACRO(EV_KEYRELEASE, Macro_1),
	ID(Button_2), TYPEID_BUTTON, WORD(80), WORD(80), 1, 160, 1, 0, 1, 1, 
		XYREF(OutputString_2, -4, 22),
	...
	ID(OutputString_S1), TYPEID_OUTSTR, WORD(72), WORD(72), COLOR_WHITE, ID(FontAttributes_23000), 1,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_2), TYPEID_OUTSTR, WORD(80), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
