...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(Macro_1), TYPEID_MACRO, WORD(16),
		...
		CMD_CONTROL_AUDIO_DEVICE, 3, WORD(440), WORD(400), WORD(500)
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 10, 0, 
		...
		XYREF(Button_S2, 400, 4),
		XYREF(Button_S3, 400, 84),
		XYREF(Button_S4, 400, 163),
	ID(DataMask_S2), TYPEID_DATAMASK, COLOR(230), ID(ID_NULL), 1, 0, 
		XYREF(Button_S1, 375, 90),
	...
	ID(Button_S2), TYPEID_BUTTON, WORD(80), WORD(80), 187, 144, 1, 0, 1, 1, 
		XYREF(OutputString_S2, 0, 0),
		MACRO(EV_KEYRELEASE, Macro_2),
	ID(Button_S1), TYPEID_BUTTON, WORD(80), WORD(80), 187, 144, 1, 0, 1, 1, 
		XYREF(OutputString_S1, 0, 0),
		MACRO(EV_KEYRELEASE, Macro_1),
	ID(Button_S3), TYPEID_BUTTON, WORD(80), WORD(80), 187, 144, 1, 0, 1, 1, 
		XYREF(OutputString_S3, 0, 0),
		MACRO(EV_KEYRELEASE, Macro_3),
	ID(Button_S4), TYPEID_BUTTON, WORD(80), WORD(80), 187, 144, 1, 0, 1, 1, 
		XYREF(OutputString_S4, 0, 0),
	...
	ID(OutputString_S2), TYPEID_OUTSTR, WORD(72), WORD(72), COLOR_WHITE, ID(FontAttributes_Default), 1,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_S1), TYPEID_OUTSTR, WORD(72), WORD(72), COLOR_WHITE, ID(FontAttributes_Default), 1,
		ID(ID_NULL), 1, WORD(4), 'S', '1', ' ', ' ', 0,
	ID(OutputString_S3), TYPEID_OUTSTR, WORD(72), WORD(72), COLOR_WHITE, ID(FontAttributes_Default), 1,
		ID(ID_NULL), 1, WORD(4), 'w', 'e', 'g', ' ', 0,
	ID(OutputString_S4), TYPEID_OUTSTR, WORD(72), WORD(72), COLOR_WHITE, ID(FontAttributes_Default), 1,
		ID(ID_NULL), 1, WORD(4), 'h', 'i', 'n', ' ', 0,
